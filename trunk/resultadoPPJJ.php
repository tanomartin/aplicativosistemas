...
for($i = 0; $i < count($filas); $i++) {
	...
	$sql = "INSERT INTO ppjj VALUES ('".trim($datos[0])."','".trim($datos[1])."','".trim($datos[2])."','".trim($datos[3])."','".trim($datos[4])."','".trim($datos[5])."','".trim($datos[6])."','".trim($datos[7])."','".trim($datos[8])."','".trim($datos[9])."','".trim($datos[10])."')";
...
<table border="1" width="100%">
  <tr> 
    <td width="50%" align="center" bgcolor="#C0C0C0"><font face="Verdana" size="1" color="#FF0000"><b><a href="procesoPPJJ.php">VOLVER</a></b></font></td>
  </tr>
</table>
</body>
</html>